...
GLMesh::GLMesh(const IndexedMesh &_indexedMesh)
    :funcs(getGLFunctions()),indexedMesh(_indexedMesh)
{
    ...
    funcs->glBufferData(GL_ELEMENT_ARRAY_BUFFER, indexedMesh.indices.size() * sizeof(GLuint), indexedMesh.indices.data(), GL_STATIC_DRAW);
